...
class EnableDisable extends StatefulWidget {
  @override
  _EnableDisableState createState() => _EnableDisableState();
}

class _EnableDisableState extends State<EnableDisable> {
                              ...
                              onPressed: () {
                                if (isEmail(search.text) == false) {
                                  Alert(
                                          ...
                                          desc:
                                              'Please enter a valid email address. ex: member@example.com')
                                      .show();
                                } else {
