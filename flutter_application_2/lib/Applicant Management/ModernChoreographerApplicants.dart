...
class ModernChoreographerApplicants extends StatefulWidget {
  TextEditingController search = TextEditingController();

  @override
  _ModernChoreographerApplicantsState createState() =>
      _ModernChoreographerApplicantsState();
}

class _ModernChoreographerApplicantsState
    extends State<ModernChoreographerApplicants> {
  @override
          ...
          child: Column(
            children: [
                ...
                child: SizedBox(
                  ...
                  child: TextField(
                    ...
                    decoration: InputDecoration(
                      ...
                      hintText: 'Search for modern choreographer',
                      hintStyle: TextStyle(
                        color: Color(0xFFEF8242),
                        fontSize: 17,
                        fontFamily: 'Poppins',
                      ...
                      suffixIcon: IconButton(
                        onPressed: () {
                          dbContext.fetchModernChoreographerApplicants(
              ...
              StreamBuilder<QuerySnapshot>(
                  stream: dbContext.fetchModernChoreographerApplicants(
                      widget.search.text.trim()),
