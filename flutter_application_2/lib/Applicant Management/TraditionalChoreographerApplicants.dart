...
import '/Controllers%20and%20other%20stuff/Cont.dart';
import '/Models/Member.dart';
import '/R/Applicant_Check.dart';
import '/R/Applicant_Details.dart';
import '/R/Approval_Page.dart';
import '/R/ShowCV.dart';
...
class TraditionalChoreographerApplicants extends StatefulWidget {
  TextEditingController search = TextEditingController();

  @override
  _TraditionalChoreographerApplicantsState createState() =>
      _TraditionalChoreographerApplicantsState();
}

class _TraditionalChoreographerApplicantsState
    extends State<TraditionalChoreographerApplicants> {
  @override
          ...
          child: Column(
            children: [
                  ...
                  child: TextField(
                    ...
                    decoration: InputDecoration(
                      ...
                      suffixIcon: IconButton(
                        onPressed: () {
                          dbContext.fetchTraditionalChoreographerApplicants(
              ...
              StreamBuilder<QuerySnapshot>(
                  stream: dbContext.fetchTraditionalChoreographerApplicants(
                      widget.search.text.trim()),
                                ...
                                child: Card(
                                  ...
                                  child: ListTile(
                                    onTap: () async {
                                      ...
                                      // Navigator.push(
                                      //     context,
                                      //      MaterialPageRoute(builder: (context) => accept_form(
