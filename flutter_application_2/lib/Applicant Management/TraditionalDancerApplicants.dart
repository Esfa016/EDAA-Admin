...
import '/Applicant%20Management/AppliManag_page.dart';
...
class TraditionalDancerApplicants extends StatefulWidget {
  TextEditingController search = TextEditingController();
  @override
  _TraditionalDancerApplicantsState createState() => _TraditionalDancerApplicantsState();
}

class _TraditionalDancerApplicantsState extends State<TraditionalDancerApplicants> {
  @override
          ...
          child: Column(
            children: [
                ...
                child: SizedBox(
                  ...
                  child: TextField(
                    ...
                    decoration: InputDecoration(
                      ...
                      hintText: 'Search for tradtional dancers',
                      hintStyle: TextStyle(
                        color: Color(0xFFEF8242),
                        fontSize: 17,
                        fontFamily: 'Poppins',
              ...
              StreamBuilder<QuerySnapshot>(
                  ...
                  stream: dbContext.fetchTraditonalDancerApplinants(widget.search.text.trim()),
                  ...
                  builder: (context,snapshot)
                  {
                    if(snapshot.connectionState == ConnectionState.waiting)
                      ...
                      return Center(
                          child: Container(
                              child: Text('could not find applicant', style: TextStyle(
                                fontFamily: 'Poppins',
                                  ...
                                  child: ListTile(
                                    onTap: ()async{
                                      ...
                                      showDialogFunction(context,
                                          ...
                                          documentSnapshot['houseNumberResidence'],
                                          documentSnapshot['subCityResidence'],
                                          documentSnapshot['postalCodeResidence'],
                                    ...
                                    title: Row(
                                      children: [
                                        ...
                                        SizedBox(width: 10,),
                                        Text((documentSnapshot!= null) ? (documentSnapshot['fullName']):'',style: TextStyle(
                                          fontSize: 20,
                                          color: AppColor.orange,
                                        ),
                                          textScaleFactor: 1.5,),
                                    ...
                                    subtitle: Row(
                                      mainAxisAlignment: MainAxisAlignment.spaceBetween,
                                      children: [
                                        Text((documentSnapshot!= null) ? (documentSnapshot['artistCategory']):'',style: TextStyle(
                                          fontSize: 10,
                                          ...
                                          children: [
                                            ...
                                            IconButton(
                                              onPressed: (){
                                                ...
                                                dbContext.declineApplicant(documentSnapshot['userID'])
                                                    .then((value) => {
                                                  dbContext.delApplicants(documentSnapshot['userID'], documentSnapshot['artistCategory'],)
                                                });
